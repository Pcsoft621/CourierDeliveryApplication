...
class Courier_Details extends StatefulWidget {
  const Courier_Details({super.key});

  @override
  State<Courier_Details> createState() => _Courier_DetailsState();
}

class _Courier_DetailsState extends State<Courier_Details> {
  @override
       ...
       child: Column(
                  ...
                  child: DropdownButton<String>(
                    ...
                    items: [
                      const DropdownMenuItem(
                        child: Text("Select Courier Type",style: TextStyle(color:Color.fromARGB(255, 119, 118, 118)),),
                        value: ""),
          ...
          Material(
           ...
           child: SizedBox(
            ...
            style: TextStyle(color: Color.fromARGB(255, 241, 242, 243), fontWeight: FontWeight.bold, fontSize: 15)),
         ...
         Material(
            ...
            child: ElevatedButton(
                     ...
                     showDialog(
                         ...
                         builder: (context) {
                        return AlertDialog(
                              content: Text(productName.text +" "+ couriertype +" "+ productWeight.text + " "+ productCharges.text+ " "+
                              locationFrom.text+" " + locationTo.text+" "+ productReceiver.text+" "+productDescription.text),
                        );
                      },
                   );
                },
